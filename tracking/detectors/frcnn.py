import sys
import os
sys.path.append(os.path.abspath('detectors/frcnn_utils/pytorch-faster-rcnn/lib'))
sys.path.append(os.path.abspath('detectors/frcnn_utils/pytorch-faster-rcnn/tools'))
